...
```markdown
---
'@openwebconcept/<package-name>': major
---
...
- `"@openwebconcept/<package-name>": major` voor breaking changes
- `"@openwebconcept/<package-name>": minor` voor nieuwe features
- `"@openwebconcept/<package-name>": patch` voor bug fixes
